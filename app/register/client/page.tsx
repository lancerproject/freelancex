      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-16">
        <div className="w-full max-w-md">
          ...
          <p className="text-neutral-500 text-center mb-6">
            Post jobs and hire top freelancers on Xwork.
          </p>
          ...
          <form action={signUpWithEmail} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <input
                ...
                required
                className="w-full border border-neutral-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-primary/40"
              />
              <input
                type="text"
                name="lastname"
            ...
            <select
              ...
              required
              defaultValue=""
              className="w-full border border-neutral-300 rounded-lg py-3 px-4 bg-white focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
            ...
            <label className="flex items-start gap-2 text-sm text-neutral-600">
              ...
              />
              Send me helpful emails to find rewarding work and great talent.
            </label>
            <label className="flex items-start gap-2 text-sm text-neutral-600">
              <input
                type="checkbox"
